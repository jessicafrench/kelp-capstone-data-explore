...
## Next is the mean nitrogen data from noaa, downloadable [here](https://www.fisheries.noaa.gov/inport/item/66153)

I am going to try this [tutorial](https://workshops.distancesampling.org/duke-spatial-2015/practicals/process-geodata-2.html)

```{r}
# Load in rgdal
library(rgdal)

# use ogrListLayers show all of the layers in the file and then you can read in only the layers we want. 
ogrListLayers("/Users/jfrench/Documents/MEDS/Capstone/DATA/Nitrogen_Data/NitrateMeanConcentration_NOAA/NitrateMeanConcentration.gdb")
```
