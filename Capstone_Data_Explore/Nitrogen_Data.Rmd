...
# Convert the date column to a data so we can filter by year, for now I am assuming YMD for the date format but need to get ahold of the researchers before commiting to that. Convert lat and lon into point geom.
...
## Next is the mean nitrogen data from noaa
